(module=>{
"use strict";var ve=Object.defineProperty;var ze=Object.getOwnPropertyDescriptor;var Ke=Object.getOwnPropertyNames;var _e=Object.prototype.hasOwnProperty;var Ve=(e,t)=>{for(var n in t)ve(e,n,{get:t[n],enumerable:!0})},Ye=(e,t,n,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let u of Ke(t))!_e.call(e,u)&&u!==n&&ve(e,u,{get:()=>t[u],enumerable:!(i=ze(t,u))||i.enumerable});return e};var Je=e=>Ye(ve({},"__esModule",{value:!0}),e);var te=(e,t,n)=>new Promise((i,u)=>{var l=p=>{try{s(n.next(p))}catch(b){u(b)}},f=p=>{try{s(n.throw(p))}catch(b){u(b)}},s=p=>p.done?i(p.value):Promise.resolve(p.value).then(l,f);s((n=n.apply(e,t)).next())});var we={};Ve(we,{analyzeMetafile:()=>dt,analyzeMetafileSync:()=>yt,build:()=>at,buildSync:()=>pt,context:()=>ut,default:()=>wt,formatMessages:()=>ft,formatMessagesSync:()=>mt,initialize:()=>ht,transform:()=>ct,transformSync:()=>gt,version:()=>ot});module.exports=Je(we);function Oe(e){let t=i=>{if(i===null)n.write8(0);else if(typeof i=="boolean")n.write8(1),n.write8(+i);else if(typeof i=="number")n.write8(2),n.write32(i|0);else if(typeof i=="string")n.write8(3),n.write(Z(i));else if(i instanceof Uint8Array)n.write8(4),n.write(i);else if(i instanceof Array){n.write8(5),n.write32(i.length);for(let u of i)t(u)}else{let u=Object.keys(i);n.write8(6),n.write32(u.length);for(let l of u)n.write(Z(l)),t(i[l])}},n=new pe;return n.write32(0),n.write32(e.id<<1|+!e.isRequest),t(e.value),Re(n.buf,n.len-4,0),n.buf.subarray(0,n.len)}function ke(e){let t=()=>{switch(n.read8()){case 0:return null;case 1:return!!n.read8();case 2:return n.read32();case 3:return ie(n.read());case 4:return n.read();case 5:{let f=n.read32(),s=[];for(let p=0;p<f;p++)s.push(t());return s}case 6:{let f=n.read32(),s={};for(let p=0;p<f;p++)s[ie(n.read())]=t();return s}default:throw new Error("Invalid packet")}},n=new pe(e),i=n.read32(),u=(i&1)===0;i>>>=1;let l=t();if(n.ptr!==e.length)throw new Error("Invalid packet");return{id:i,isRequest:u,value:l}}var pe=class{constructor(t=new Uint8Array(1024)){this.buf=t;this.len=0;this.ptr=0}_write(t){if(this.len+t>this.buf.length){let n=new Uint8Array((this.len+t)*2);n.set(this.buf),this.buf=n}return this.len+=t,this.len-t}write8(t){let n=this._write(1);this.buf[n]=t}write32(t){let n=this._write(4);Re(this.buf,t,n)}write(t){let n=this._write(4+t.length);Re(this.buf,t.length,n),this.buf.set(t,n+4)}_read(t){if(this.ptr+t>this.buf.length)throw new Error("Invalid packet");return this.ptr+=t,this.ptr-t}read8(){return this.buf[this._read(1)]}read32(){return Ee(this.buf,this._read(4))}read(){let t=this.read32(),n=new Uint8Array(t),i=this._read(n.length);return n.set(this.buf.subarray(i,i+t)),n}},Z,ie,xe;if(typeof TextEncoder!="undefined"&&typeof TextDecoder!="undefined"){let e=new TextEncoder,t=new TextDecoder;Z=n=>e.encode(n),ie=n=>t.decode(n),xe='new TextEncoder().encode("")'}else if(typeof Buffer!="undefined")Z=e=>Buffer.from(e),ie=e=>{let{buffer:t,byteOffset:n,byteLength:i}=e;return Buffer.from(t,n,i).toString()},xe='Buffer.from("")';else throw new Error("No UTF-8 codec found");if(!(Z("")instanceof Uint8Array))throw new Error(`Invariant violation: "${xe} instanceof Uint8Array" is incorrectly false

This indicates that your JavaScript environment is broken. You cannot use
esbuild in this environment because esbuild relies on this invariant. This
is not a problem with esbuild. You need to fix your environment instead.
`);function Ee(e,t){return e[t++]|e[t++]<<8|e[t++]<<16|e[t++]<<24}function Re(e,t,n){e[n++]=t,e[n++]=t>>8,e[n++]=t>>16,e[n++]=t>>24}var Y=JSON.stringify,$e="warning",Me="silent";function Ce(e){if(V(e,"target"),e.indexOf(",")>=0)throw new Error(`Invalid target: ${e}`);return e}var ye=()=>null,I=e=>typeof e=="boolean"?null:"a boolean",y=e=>typeof e=="string"?null:"a string",he=e=>e instanceof RegExp?null:"a RegExp object",se=e=>typeof e=="number"&&e===(e|0)?null:"an integer",Pe=e=>typeof e=="function"?null:"a function",W=e=>Array.isArray(e)?null:"an array",ee=e=>typeof e=="object"&&e!==null&&!Array.isArray(e)?null:"an object",He=e=>typeof e=="object"&&e!==null?null:"an array or an object",Ge=e=>e instanceof WebAssembly.Module?null:"a WebAssembly.Module",Ae=e=>typeof e=="object"&&!Array.isArray(e)?null:"an object or null",Fe=e=>typeof e=="string"||typeof e=="boolean"?null:"a string or a boolean",Xe=e=>typeof e=="string"||typeof e=="object"&&e!==null&&!Array.isArray(e)?null:"a string or an object",Ze=e=>typeof e=="string"||Array.isArray(e)?null:"a string or an array",Te=e=>typeof e=="string"||e instanceof Uint8Array?null:"a string or a Uint8Array",et=e=>typeof e=="string"||e instanceof URL?null:"a string or a URL";function r(e,t,n,i){let u=e[n];if(t[n+""]=!0,u===void 0)return;let l=i(u);if(l!==null)throw new Error(`${Y(n)} must be ${l}`);return u}function K(e,t,n){for(let i in e)if(!(i in t))throw new Error(`Invalid option ${n}: ${Y(i)}`)}function Be(e){let t=Object.create(null),n=r(e,t,"wasmURL",et),i=r(e,t,"wasmModule",Ge),u=r(e,t,"worker",I);return K(e,t,"in initialize() call"),{wasmURL:n,wasmModule:i,worker:u}}function Ue(e){let t;if(e!==void 0){t=Object.create(null);for(let n in e){let i=e[n];if(typeof i=="string"||i===!1)t[n]=i;else throw new Error(`Expected ${Y(n)} in mangle cache to map to either a string or false`)}}return t}function be(e,t,n,i,u){let l=r(t,n,"color",I),f=r(t,n,"logLevel",y),s=r(t,n,"logLimit",se);l!==void 0?e.push(`--color=${l}`):i&&e.push("--color=true"),e.push(`--log-level=${f||u}`),e.push(`--log-limit=${s||0}`)}function V(e,t,n){if(typeof e!="string")throw new Error(`Expected value for ${t}${n!==void 0?" "+Y(n):""} to be a string, got ${typeof e} instead`);return e}function je(e,t,n){let i=r(t,n,"legalComments",y),u=r(t,n,"sourceRoot",y),l=r(t,n,"sourcesContent",I),f=r(t,n,"target",Ze),s=r(t,n,"format",y),p=r(t,n,"globalName",y),b=r(t,n,"mangleProps",he),w=r(t,n,"reserveProps",he),T=r(t,n,"mangleQuoted",I),j=r(t,n,"minify",I),U=r(t,n,"minifySyntax",I),L=r(t,n,"minifyWhitespace",I),Q=r(t,n,"minifyIdentifiers",I),B=r(t,n,"lineLimit",se),z=r(t,n,"drop",W),J=r(t,n,"dropLabels",W),v=r(t,n,"charset",y),m=r(t,n,"treeShaking",I),d=r(t,n,"ignoreAnnotations",I),o=r(t,n,"jsx",y),x=r(t,n,"jsxFactory",y),k=r(t,n,"jsxFragment",y),M=r(t,n,"jsxImportSource",y),D=r(t,n,"jsxDev",I),a=r(t,n,"jsxSideEffects",I),c=r(t,n,"define",ee),h=r(t,n,"logOverride",ee),E=r(t,n,"supported",ee),C=r(t,n,"pure",W),S=r(t,n,"keepNames",I),O=r(t,n,"platform",y),A=r(t,n,"tsconfigRaw",Xe);if(i&&e.push(`--legal-comments=${i}`),u!==void 0&&e.push(`--source-root=${u}`),l!==void 0&&e.push(`--sources-content=${l}`),f&&(Array.isArray(f)?e.push(`--target=${Array.from(f).map(Ce).join(",")}`):e.push(`--target=${Ce(f)}`)),s&&e.push(`--format=${s}`),p&&e.push(`--global-name=${p}`),O&&e.push(`--platform=${O}`),A&&e.push(`--tsconfig-raw=${typeof A=="string"?A:JSON.stringify(A)}`),j&&e.push("--minify"),U&&e.push("--minify-syntax"),L&&e.push("--minify-whitespace"),Q&&e.push("--minify-identifiers"),B&&e.push(`--line-limit=${B}`),v&&e.push(`--charset=${v}`),m!==void 0&&e.push(`--tree-shaking=${m}`),d&&e.push("--ignore-annotations"),z)for(let R of z)e.push(`--drop:${V(R,"drop")}`);if(J&&e.push(`--drop-labels=${Array.from(J).map(R=>V(R,"dropLabels")).join(",")}`),b&&e.push(`--mangle-props=${b.source}`),w&&e.push(`--reserve-props=${w.source}`),T!==void 0&&e.push(`--mangle-quoted=${T}`),o&&e.push(`--jsx=${o}`),x&&e.push(`--jsx-factory=${x}`),k&&e.push(`--jsx-fragment=${k}`),M&&e.push(`--jsx-import-source=${M}`),D&&e.push("--jsx-dev"),a&&e.push("--jsx-side-effects"),c)for(let R in c){if(R.indexOf("=")>=0)throw new Error(`Invalid define: ${R}`);e.push(`--define:${R}=${V(c[R],"define",R)}`)}if(h)for(let R in h){if(R.indexOf("=")>=0)throw new Error(`Invalid log override: ${R}`);e.push(`--log-override:${R}=${V(h[R],"log override",R)}`)}if(E)for(let R in E){if(R.indexOf("=")>=0)throw new Error(`Invalid supported: ${R}`);let $=E[R];if(typeof $!="boolean")throw new Error(`Expected value for supported ${Y(R)} to be a boolean, got ${typeof $} instead`);e.push(`--supported:${R}=${$}`)}if(C)for(let R of C)e.push(`--pure:${V(R,"pure")}`);S&&e.push("--keep-names")}function tt(e,t,n,i,u){var oe;let l=[],f=[],s=Object.create(null),p=null,b=null;be(l,t,s,n,i),je(l,t,s);let w=r(t,s,"sourcemap",Fe),T=r(t,s,"bundle",I),j=r(t,s,"splitting",I),U=r(t,s,"preserveSymlinks",I),L=r(t,s,"metafile",I),Q=r(t,s,"outfile",y),B=r(t,s,"outdir",y),z=r(t,s,"outbase",y),J=r(t,s,"tsconfig",y),v=r(t,s,"resolveExtensions",W),m=r(t,s,"nodePaths",W),d=r(t,s,"mainFields",W),o=r(t,s,"conditions",W),x=r(t,s,"external",W),k=r(t,s,"packages",y),M=r(t,s,"alias",ee),D=r(t,s,"loader",ee),a=r(t,s,"outExtension",ee),c=r(t,s,"publicPath",y),h=r(t,s,"entryNames",y),E=r(t,s,"chunkNames",y),C=r(t,s,"assetNames",y),S=r(t,s,"inject",W),O=r(t,s,"banner",ee),A=r(t,s,"footer",ee),R=r(t,s,"entryPoints",He),$=r(t,s,"absWorkingDir",y),F=r(t,s,"stdin",ee),P=(oe=r(t,s,"write",I))!=null?oe:u,q=r(t,s,"allowOverwrite",I),_=r(t,s,"mangleCache",ee);if(s.plugins=!0,K(t,s,`in ${e}() call`),w&&l.push(`--sourcemap${w===!0?"":`=${w}`}`),T&&l.push("--bundle"),q&&l.push("--allow-overwrite"),j&&l.push("--splitting"),U&&l.push("--preserve-symlinks"),L&&l.push("--metafile"),Q&&l.push(`--outfile=${Q}`),B&&l.push(`--outdir=${B}`),z&&l.push(`--outbase=${z}`),J&&l.push(`--tsconfig=${J}`),k&&l.push(`--packages=${k}`),v){let g=[];for(let N of v){if(V(N,"resolve extension"),N.indexOf(",")>=0)throw new Error(`Invalid resolve extension: ${N}`);g.push(N)}l.push(`--resolve-extensions=${g.join(",")}`)}if(c&&l.push(`--public-path=${c}`),h&&l.push(`--entry-names=${h}`),E&&l.push(`--chunk-names=${E}`),C&&l.push(`--asset-names=${C}`),d){let g=[];for(let N of d){if(V(N,"main field"),N.indexOf(",")>=0)throw new Error(`Invalid main field: ${N}`);g.push(N)}l.push(`--main-fields=${g.join(",")}`)}if(o){let g=[];for(let N of o){if(V(N,"condition"),N.indexOf(",")>=0)throw new Error(`Invalid condition: ${N}`);g.push(N)}l.push(`--conditions=${g.join(",")}`)}if(x)for(let g of x)l.push(`--external:${V(g,"external")}`);if(M)for(let g in M){if(g.indexOf("=")>=0)throw new Error(`Invalid package name in alias: ${g}`);l.push(`--alias:${g}=${V(M[g],"alias",g)}`)}if(O)for(let g in O){if(g.indexOf("=")>=0)throw new Error(`Invalid banner file type: ${g}`);l.push(`--banner:${g}=${V(O[g],"banner",g)}`)}if(A)for(let g in A){if(g.indexOf("=")>=0)throw new Error(`Invalid footer file type: ${g}`);l.push(`--footer:${g}=${V(A[g],"footer",g)}`)}if(S)for(let g of S)l.push(`--inject:${V(g,"inject")}`);if(D)for(let g in D){if(g.indexOf("=")>=0)throw new Error(`Invalid loader extension: ${g}`);l.push(`--loader:${g}=${V(D[g],"loader",g)}`)}if(a)for(let g in a){if(g.indexOf("=")>=0)throw new Error(`Invalid out extension: ${g}`);l.push(`--out-extension:${g}=${V(a[g],"out extension",g)}`)}if(R)if(Array.isArray(R))for(let g=0,N=R.length;g<N;g++){let G=R[g];if(typeof G=="object"&&G!==null){let X=Object.create(null),re=r(G,X,"in",y),de=r(G,X,"out",y);if(K(G,X,"in entry point at index "+g),re===void 0)throw new Error('Missing property "in" for entry point at index '+g);if(de===void 0)throw new Error('Missing property "out" for entry point at index '+g);f.push([de,re])}else f.push(["",V(G,"entry point at index "+g)])}else for(let g in R)f.push([g,V(R[g],"entry point",g)]);if(F){let g=Object.create(null),N=r(F,g,"contents",Te),G=r(F,g,"resolveDir",y),X=r(F,g,"sourcefile",y),re=r(F,g,"loader",y);K(F,g,'in "stdin" object'),X&&l.push(`--sourcefile=${X}`),re&&l.push(`--loader=${re}`),G&&(b=G),typeof N=="string"?p=Z(N):N instanceof Uint8Array&&(p=N)}let H=[];if(m)for(let g of m)g+="",H.push(g);return{entries:f,flags:l,write:P,stdinContents:p,stdinResolveDir:b,absWorkingDir:$,nodePaths:H,mangleCache:Ue(_)}}function nt(e,t,n,i){let u=[],l=Object.create(null);be(u,t,l,n,i),je(u,t,l);let f=r(t,l,"sourcemap",Fe),s=r(t,l,"sourcefile",y),p=r(t,l,"loader",y),b=r(t,l,"banner",y),w=r(t,l,"footer",y),T=r(t,l,"mangleCache",ee);return K(t,l,`in ${e}() call`),f&&u.push(`--sourcemap=${f===!0?"external":f}`),s&&u.push(`--sourcefile=${s}`),p&&u.push(`--loader=${p}`),b&&u.push(`--banner=${b}`),w&&u.push(`--footer=${w}`),{flags:u,mangleCache:Ue(T)}}function Le(e){let t={},n={didClose:!1,reason:""},i={},u=0,l=0,f=new Uint8Array(16*1024),s=0,p=v=>{let m=s+v.length;if(m>f.length){let o=new Uint8Array(m*2);o.set(f),f=o}f.set(v,s),s+=v.length;let d=0;for(;d+4<=s;){let o=Ee(f,d);if(d+4+o>s)break;d+=4,L(f.subarray(d,d+o)),d+=o}d>0&&(f.copyWithin(0,d,s),s-=d)},b=v=>{n.didClose=!0,v&&(n.reason=": "+(v.message||v));let m="The service was stopped"+n.reason;for(let d in i)i[d](m,null);i={}},w=(v,m,d)=>{if(n.didClose)return d("The service is no longer running"+n.reason,null);let o=u++;i[o]=(x,k)=>{try{d(x,k)}finally{v&&v.unref()}},v&&v.ref(),e.writeToStdin(Oe({id:o,isRequest:!0,value:m}))},T=(v,m)=>{if(n.didClose)throw new Error("The service is no longer running"+n.reason);e.writeToStdin(Oe({id:v,isRequest:!1,value:m}))},j=(v,m)=>te(this,null,function*(){try{if(m.command==="ping"){T(v,{});return}if(typeof m.key=="number"){let d=t[m.key];if(d){let o=d[m.command];if(o){yield o(v,m);return}}}throw new Error("Invalid command: "+m.command)}catch(d){let o=[le(d,e,null,void 0,"")];try{T(v,{errors:o})}catch(x){}}}),U=!0,L=v=>{if(U){U=!1;let d=String.fromCharCode(...v);if(d!=="0.18.14")throw new Error(`Cannot start service: Host version "0.18.14" does not match binary version ${Y(d)}`);return}let m=ke(v);if(m.isRequest)j(m.id,m.value);else{let d=i[m.id];delete i[m.id],m.value.error?d(m.value.error,{}):d(null,m.value)}};return{readFromStdout:p,afterClose:b,service:{buildOrContext:({callName:v,refs:m,options:d,isTTY:o,defaultWD:x,callback:k})=>{let M=0,D=l++,a={},c={ref(){++M===1&&m&&m.ref()},unref(){--M===0&&(delete t[D],m&&m.unref())}};t[D]=a,c.ref(),rt(v,D,w,T,c,e,a,d,o,x,(h,E)=>{try{k(h,E)}finally{c.unref()}})},transform:({callName:v,refs:m,input:d,options:o,isTTY:x,fs:k,callback:M})=>{let D=qe(),a=c=>{try{if(typeof d!="string"&&!(d instanceof Uint8Array))throw new Error('The input to "transform" must be a string or a Uint8Array');let{flags:h,mangleCache:E}=nt(v,o,x,Me),C={command:"transform",flags:h,inputFS:c!==null,input:c!==null?Z(c):typeof d=="string"?Z(d):d};E&&(C.mangleCache=E),w(m,C,(S,O)=>{if(S)return M(new Error(S),null);let A=ae(O.errors,D),R=ae(O.warnings,D),$=1,F=()=>{if(--$===0){let P={warnings:R,code:O.code,map:O.map,mangleCache:void 0,legalComments:void 0};"legalComments"in O&&(P.legalComments=O==null?void 0:O.legalComments),O.mangleCache&&(P.mangleCache=O==null?void 0:O.mangleCache),M(null,P)}};if(A.length>0)return M(ce("Transform failed",A,R),null);O.codeFS&&($++,k.readFile(O.code,(P,q)=>{P!==null?M(P,null):(O.code=q,F())})),O.mapFS&&($++,k.readFile(O.map,(P,q)=>{P!==null?M(P,null):(O.map=q,F())})),F()})}catch(h){let E=[];try{be(E,o,{},x,Me)}catch(S){}let C=le(h,e,D,void 0,"");w(m,{command:"error",flags:E,error:C},()=>{C.detail=D.load(C.detail),M(ce("Transform failed",[C],[]),null)})}};if((typeof d=="string"||d instanceof Uint8Array)&&d.length>1024*1024){let c=a;a=()=>k.writeFile(d,c)}a(null)},formatMessages:({callName:v,refs:m,messages:d,options:o,callback:x})=>{let k=ne(d,"messages",null,"");if(!o)throw new Error(`Missing second argument in ${v}() call`);let M={},D=r(o,M,"kind",y),a=r(o,M,"color",I),c=r(o,M,"terminalWidth",se);if(K(o,M,`in ${v}() call`),D===void 0)throw new Error(`Missing "kind" in ${v}() call`);if(D!=="error"&&D!=="warning")throw new Error(`Expected "kind" to be "error" or "warning" in ${v}() call`);let h={command:"format-msgs",messages:k,isWarning:D==="warning"};a!==void 0&&(h.color=a),c!==void 0&&(h.terminalWidth=c),w(m,h,(E,C)=>{if(E)return x(new Error(E),null);x(null,C.messages)})},analyzeMetafile:({callName:v,refs:m,metafile:d,options:o,callback:x})=>{o===void 0&&(o={});let k={},M=r(o,k,"color",I),D=r(o,k,"verbose",I);K(o,k,`in ${v}() call`);let a={command:"analyze-metafile",metafile:d};M!==void 0&&(a.color=M),D!==void 0&&(a.verbose=D),w(m,a,(c,h)=>{if(c)return x(new Error(c),null);x(null,h.result)})}}}}function rt(e,t,n,i,u,l,f,s,p,b,w){let T=qe(),j=e==="context",U=(B,z)=>{let J=[];try{be(J,s,{},p,$e)}catch(m){}let v=le(B,l,T,void 0,z);n(u,{command:"error",flags:J,error:v},()=>{v.detail=T.load(v.detail),w(ce(j?"Context failed":"Build failed",[v],[]),null)})},L;if(typeof s=="object"){let B=s.plugins;if(B!==void 0){if(!Array.isArray(B))return U(new Error('"plugins" must be an array'),"");L=B}}if(L&&L.length>0){if(l.isSync)return U(new Error("Cannot use plugins in synchronous API calls"),"");it(t,n,i,u,l,f,s,L,T).then(B=>{if(!B.ok)return U(B.error,B.pluginName);try{Q(B.requestPlugins,B.runOnEndCallbacks,B.scheduleOnDisposeCallbacks)}catch(z){U(z,"")}},B=>U(B,""));return}try{Q(null,(B,z)=>z([],[]),()=>{})}catch(B){U(B,"")}function Q(B,z,J){let v=l.hasFS,{entries:m,flags:d,write:o,stdinContents:x,stdinResolveDir:k,absWorkingDir:M,nodePaths:D,mangleCache:a}=tt(e,s,p,$e,v);if(o&&!l.hasFS)throw new Error('The "write" option is unavailable in this environment');let c={command:"build",key:t,entries:m,flags:d,write:o,stdinContents:x,stdinResolveDir:k,absWorkingDir:M||b,nodePaths:D,context:j};B&&(c.plugins=B),a&&(c.mangleCache=a);let h=(S,O)=>{let A={errors:ae(S.errors,T),warnings:ae(S.warnings,T),outputFiles:void 0,metafile:void 0,mangleCache:void 0},R=A.errors.slice(),$=A.warnings.slice();S.outputFiles&&(A.outputFiles=S.outputFiles.map(lt)),S.metafile&&(A.metafile=JSON.parse(S.metafile)),S.mangleCache&&(A.mangleCache=S.mangleCache),S.writeToStdout!==void 0&&console.log(ie(S.writeToStdout).replace(/\n$/,"")),z(A,(F,P)=>{if(R.length>0||F.length>0){let q=ce("Build failed",R.concat(F),$.concat(P));return O(q,null,F,P)}O(null,A,F,P)})},E,C;j&&(f["on-end"]=(S,O)=>new Promise(A=>{h(O,(R,$,F,P)=>{let q={errors:F,warnings:P};C&&C(R,$),E=void 0,C=void 0,i(S,q),A()})})),n(u,c,(S,O)=>{if(S)return w(new Error(S),null);if(!j)return h(O,($,F)=>(J(),w($,F)));if(O.errors.length>0)return w(ce("Context failed",O.errors,O.warnings),null);let A=!1,R={rebuild:()=>(E||(E=new Promise(($,F)=>{let P;C=(_,H)=>{P||(P=()=>_?F(_):$(H))};let q=()=>{n(u,{command:"rebuild",key:t},(H,oe)=>{H?F(new Error(H)):P?P():q()})};q()})),E),watch:($={})=>new Promise((F,P)=>{if(!l.hasFS)throw new Error('Cannot use the "watch" API in this environment');K($,{},"in watch() call"),n(u,{command:"watch",key:t},H=>{H?P(new Error(H)):F(void 0)})}),serve:($={})=>new Promise((F,P)=>{if(!l.hasFS)throw new Error('Cannot use the "serve" API in this environment');let q={},_=r($,q,"port",se),H=r($,q,"host",y),oe=r($,q,"servedir",y),g=r($,q,"keyfile",y),N=r($,q,"certfile",y),G=r($,q,"onRequest",Pe);K($,q,"in serve() call");let X={command:"serve",key:t,onRequest:!!G};_!==void 0&&(X.port=_),H!==void 0&&(X.host=H),oe!==void 0&&(X.servedir=oe),g!==void 0&&(X.keyfile=g),N!==void 0&&(X.certfile=N),n(u,X,(re,de)=>{if(re)return P(new Error(re));G&&(f["serve-request"]=(Ie,We)=>{G(We.args),i(Ie,{})}),F(de)})}),cancel:()=>new Promise($=>{if(A)return $();n(u,{command:"cancel",key:t},()=>{$()})}),dispose:()=>new Promise($=>{if(A)return $();A=!0,n(u,{command:"dispose",key:t},()=>{$(),J(),u.unref()})})};u.ref(),w(null,R)})}}var it=(e,t,n,i,u,l,f,s,p)=>te(void 0,null,function*(){let b=[],w=[],T={},j={},U=[],L=0,Q=0,B=[],z=!1;s=[...s];for(let m of s){let d={};if(typeof m!="object")throw new Error(`Plugin at index ${Q} must be an object`);let o=r(m,d,"name",y);if(typeof o!="string"||o==="")throw new Error(`Plugin at index ${Q} is missing a name`);try{let x=r(m,d,"setup",Pe);if(typeof x!="function")throw new Error("Plugin is missing a setup function");K(m,d,`on plugin ${Y(o)}`);let k={name:o,onStart:!1,onEnd:!1,onResolve:[],onLoad:[]};Q++;let D=x({initialOptions:f,resolve:(a,c={})=>{if(!z)throw new Error('Cannot call "resolve" before plugin setup has completed');if(typeof a!="string")throw new Error("The path to resolve must be a string");let h=Object.create(null),E=r(c,h,"pluginName",y),C=r(c,h,"importer",y),S=r(c,h,"namespace",y),O=r(c,h,"resolveDir",y),A=r(c,h,"kind",y),R=r(c,h,"pluginData",ye);return K(c,h,"in resolve() call"),new Promise(($,F)=>{let P={command:"resolve",path:a,key:e,pluginName:o};if(E!=null&&(P.pluginName=E),C!=null&&(P.importer=C),S!=null&&(P.namespace=S),O!=null&&(P.resolveDir=O),A!=null)P.kind=A;else throw new Error('Must specify "kind" when calling "resolve"');R!=null&&(P.pluginData=p.store(R)),t(i,P,(q,_)=>{q!==null?F(new Error(q)):$({errors:ae(_.errors,p),warnings:ae(_.warnings,p),path:_.path,external:_.external,sideEffects:_.sideEffects,namespace:_.namespace,suffix:_.suffix,pluginData:p.load(_.pluginData)})})})},onStart(a){let c='This error came from the "onStart" callback registered here:',h=ge(new Error(c),u,"onStart");b.push({name:o,callback:a,note:h}),k.onStart=!0},onEnd(a){let c='This error came from the "onEnd" callback registered here:',h=ge(new Error(c),u,"onEnd");w.push({name:o,callback:a,note:h}),k.onEnd=!0},onResolve(a,c){let h='This error came from the "onResolve" callback registered here:',E=ge(new Error(h),u,"onResolve"),C={},S=r(a,C,"filter",he),O=r(a,C,"namespace",y);if(K(a,C,`in onResolve() call for plugin ${Y(o)}`),S==null)throw new Error("onResolve() call is missing a filter");let A=L++;T[A]={name:o,callback:c,note:E},k.onResolve.push({id:A,filter:S.source,namespace:O||""})},onLoad(a,c){let h='This error came from the "onLoad" callback registered here:',E=ge(new Error(h),u,"onLoad"),C={},S=r(a,C,"filter",he),O=r(a,C,"namespace",y);if(K(a,C,`in onLoad() call for plugin ${Y(o)}`),S==null)throw new Error("onLoad() call is missing a filter");let A=L++;j[A]={name:o,callback:c,note:E},k.onLoad.push({id:A,filter:S.source,namespace:O||""})},onDispose(a){U.push(a)},esbuild:u.esbuild});D&&(yield D),B.push(k)}catch(x){return{ok:!1,error:x,pluginName:o}}}l["on-start"]=(m,d)=>te(void 0,null,function*(){let o={errors:[],warnings:[]};yield Promise.all(b.map(D=>te(void 0,[D],function*({name:x,callback:k,note:M}){try{let a=yield k();if(a!=null){if(typeof a!="object")throw new Error(`Expected onStart() callback in plugin ${Y(x)} to return an object`);let c={},h=r(a,c,"errors",W),E=r(a,c,"warnings",W);K(a,c,`from onStart() callback in plugin ${Y(x)}`),h!=null&&o.errors.push(...ne(h,"errors",p,x)),E!=null&&o.warnings.push(...ne(E,"warnings",p,x))}}catch(a){o.errors.push(le(a,u,p,M&&M(),x))}}))),n(m,o)}),l["on-resolve"]=(m,d)=>te(void 0,null,function*(){let o={},x="",k,M;for(let D of d.ids)try{({name:x,callback:k,note:M}=T[D]);let a=yield k({path:d.path,importer:d.importer,namespace:d.namespace,resolveDir:d.resolveDir,kind:d.kind,pluginData:p.load(d.pluginData)});if(a!=null){if(typeof a!="object")throw new Error(`Expected onResolve() callback in plugin ${Y(x)} to return an object`);let c={},h=r(a,c,"pluginName",y),E=r(a,c,"path",y),C=r(a,c,"namespace",y),S=r(a,c,"suffix",y),O=r(a,c,"external",I),A=r(a,c,"sideEffects",I),R=r(a,c,"pluginData",ye),$=r(a,c,"errors",W),F=r(a,c,"warnings",W),P=r(a,c,"watchFiles",W),q=r(a,c,"watchDirs",W);K(a,c,`from onResolve() callback in plugin ${Y(x)}`),o.id=D,h!=null&&(o.pluginName=h),E!=null&&(o.path=E),C!=null&&(o.namespace=C),S!=null&&(o.suffix=S),O!=null&&(o.external=O),A!=null&&(o.sideEffects=A),R!=null&&(o.pluginData=p.store(R)),$!=null&&(o.errors=ne($,"errors",p,x)),F!=null&&(o.warnings=ne(F,"warnings",p,x)),P!=null&&(o.watchFiles=me(P,"watchFiles")),q!=null&&(o.watchDirs=me(q,"watchDirs"));break}}catch(a){o={id:D,errors:[le(a,u,p,M&&M(),x)]};break}n(m,o)}),l["on-load"]=(m,d)=>te(void 0,null,function*(){let o={},x="",k,M;for(let D of d.ids)try{({name:x,callback:k,note:M}=j[D]);let a=yield k({path:d.path,namespace:d.namespace,suffix:d.suffix,pluginData:p.load(d.pluginData)});if(a!=null){if(typeof a!="object")throw new Error(`Expected onLoad() callback in plugin ${Y(x)} to return an object`);let c={},h=r(a,c,"pluginName",y),E=r(a,c,"contents",Te),C=r(a,c,"resolveDir",y),S=r(a,c,"pluginData",ye),O=r(a,c,"loader",y),A=r(a,c,"errors",W),R=r(a,c,"warnings",W),$=r(a,c,"watchFiles",W),F=r(a,c,"watchDirs",W);K(a,c,`from onLoad() callback in plugin ${Y(x)}`),o.id=D,h!=null&&(o.pluginName=h),E instanceof Uint8Array?o.contents=E:E!=null&&(o.contents=Z(E)),C!=null&&(o.resolveDir=C),S!=null&&(o.pluginData=p.store(S)),O!=null&&(o.loader=O),A!=null&&(o.errors=ne(A,"errors",p,x)),R!=null&&(o.warnings=ne(R,"warnings",p,x)),$!=null&&(o.watchFiles=me($,"watchFiles")),F!=null&&(o.watchDirs=me(F,"watchDirs"));break}}catch(a){o={id:D,errors:[le(a,u,p,M&&M(),x)]};break}n(m,o)});let J=(m,d)=>d([],[]);w.length>0&&(J=(m,d)=>{te(void 0,null,function*(){let o=[],x=[];for(let{name:k,callback:M,note:D}of w){let a,c;try{let h=yield M(m);if(h!=null){if(typeof h!="object")throw new Error(`Expected onEnd() callback in plugin ${Y(k)} to return an object`);let E={},C=r(h,E,"errors",W),S=r(h,E,"warnings",W);K(h,E,`from onEnd() callback in plugin ${Y(k)}`),C!=null&&(a=ne(C,"errors",p,k)),S!=null&&(c=ne(S,"warnings",p,k))}}catch(h){a=[le(h,u,p,D&&D(),k)]}if(a){o.push(...a);try{m.errors.push(...a)}catch(h){}}if(c){x.push(...c);try{m.warnings.push(...c)}catch(h){}}}d(o,x)})});let v=()=>{for(let m of U)setTimeout(()=>m(),0)};return z=!0,{ok:!0,requestPlugins:B,runOnEndCallbacks:J,scheduleOnDisposeCallbacks:v}});function qe(){let e=new Map,t=0;return{load(n){return e.get(n)},store(n){if(n===void 0)return-1;let i=t++;return e.set(i,n),i}}}function ge(e,t,n){let i,u=!1;return()=>{if(u)return i;u=!0;try{let l=(e.stack+"").split(`
