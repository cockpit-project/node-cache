...
export class Chip extends React.Component {
    constructor(props) {
        ...
        this.renderOverflowChip = () => {
            const _a = this.props, { children, className, onClick, ouiaId } = _a, props = __rest(_a, ["children", "className", "onClick", "ouiaId"]);
            const Component = this.props.component;
            return (React.createElement(Component, Object.assign({ onClick: onClick }, (this.props.textMaxWidth && Object.assign({ style: this.setChipStyle() }, this.props.style)), { className: css(styles.chip, styles.modifiers.overflow, className) }, (this.props.component === 'button' ? { type: 'button' } : {}), getOUIAProps('OverflowChip', ouiaId !== undefined ? ouiaId : this.state.ouiaStateId), props),
    ...
    renderInnerChip(id) {
        const _a = this.props, { children, className, onClick, closeBtnAriaLabel, isReadOnly, component, ouiaId } = _a, props = __rest(_a, ["children", "className", "onClick", "closeBtnAriaLabel", "isReadOnly", "component", "ouiaId"]);
