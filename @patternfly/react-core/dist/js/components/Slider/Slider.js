    ...
    const displayInput = () => {
        ...
        if (inputLabel) {
            return (React.createElement(InputGroup_1.InputGroup, null,
                ...
                React.createElement(InputGroup_1.InputGroupItem, { isBox: true },
                    React.createElement(InputGroup_1.InputGroupText, Object.assign({}, (isDisabled && { className: (0, react_styles_1.css)(slider_1.default.modifiers.disabled) })), inputLabel))));
        }
        else {
            return textInput;
        }
