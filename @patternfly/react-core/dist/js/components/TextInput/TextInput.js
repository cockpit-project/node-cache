...
class TextInputBase extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("div", { className: (0, react_styles_1.css)(form_control_1.default.formControl, readOnlyVariant && form_control_1.default.modifiers.readonly, readOnlyVariant === 'plain' && form_control_1.default.modifiers.plain, isDisabled && form_control_1.default.modifiers.disabled, isExpanded && form_control_1.default.modifiers.expanded, customIcon && form_control_1.default.modifiers.icon, hasStatusIcon && form_control_1.default.modifiers[validated], className) },
            ...
            (customIcon || hasStatusIcon) && (React.createElement("div", { className: (0, react_styles_1.css)(form_control_1.default.formControlUtilities) },
