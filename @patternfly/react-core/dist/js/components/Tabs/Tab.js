...
const TabBase = (_a) => {
    ...
    return (React.createElement("li", { className: (0, react_styles_1.css)(tabs_1.default.tabsItem, eventKey === localActiveKey && tabs_1.default.modifiers.current, (handleTabClose || actions) && tabs_1.default.modifiers.action, (isDisabled || isAriaDisabled) && tabs_1.default.modifiers.disabled, childClassName), role: "presentation" },
