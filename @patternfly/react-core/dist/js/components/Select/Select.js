        ...
        this.updateTypeAheadFilteredChildren = (typeaheadInputValue, e) => {
            ...
            if (isCreatable && typeaheadInputValue !== '') {
                ...
                if (!typeaheadFilteredChildren.find((i) => i.props.value.toLowerCase() === newValue.toLowerCase())) {
                    typeaheadFilteredChildren.push(React.createElement(SelectOption_1.SelectOption, { key: `create ${newValue}`, value: newValue, onClick: () => onCreateOption && onCreateOption(newValue) },
                        createText,
                        " \"",
                        newValue,
                        "\""));
