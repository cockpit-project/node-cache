...
class Chip extends React.Component {
    constructor(props) {
        ...
        this.renderOverflowChip = () => {
            const _a = this.props, { children, className, onClick, ouiaId } = _a, props = tslib_1.__rest(_a, ["children", "className", "onClick", "ouiaId"]);
            const Component = this.props.component;
            return (React.createElement(Component, Object.assign({ onClick: onClick }, (this.props.textMaxWidth && Object.assign({ style: this.setChipStyle() }, this.props.style)), { className: (0, react_styles_1.css)(chip_1.default.chip, chip_1.default.modifiers.overflow, className) }, (this.props.component === 'button' ? { type: 'button' } : {}), (0, helpers_1.getOUIAProps)('OverflowChip', ouiaId !== undefined ? ouiaId : this.state.ouiaStateId), props),
    ...
    renderInnerChip(id) {
        const _a = this.props, { children, className, onClick, closeBtnAriaLabel, isReadOnly, component, ouiaId } = _a, props = tslib_1.__rest(_a, ["children", "className", "onClick", "closeBtnAriaLabel", "isReadOnly", "component", "ouiaId"]);
