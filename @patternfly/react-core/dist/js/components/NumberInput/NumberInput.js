...
const NumberInput = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: (0, react_styles_1.css)(number_input_1.default.numberInput, validated !== 'default' && number_input_1.default.modifiers.status, className) }, (widthChars && {
        ...
        React.createElement(InputGroup_1.InputGroup, null,
            ...
            React.createElement(InputGroup_1.InputGroupItem, null,
                React.createElement(TextInput_1.TextInput, Object.assign({}, inputProps, { type: "number", value: value, name: inputName, "aria-label": inputAriaLabel }, (isDisabled && { isDisabled }), (onChange && { onChange: (event, _value) => onChange(event) }), { onBlur: handleBlur }, (!onChange && { isReadOnly: true }), { onKeyDown: keyDownHandler, validated: validated }))),
            React.createElement(InputGroup_1.InputGroupItem, null,
