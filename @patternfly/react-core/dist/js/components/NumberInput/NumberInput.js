...
const NumberInput = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: react_styles_1.css(number_input_1.default.numberInput, validated !== 'default' && number_input_1.default.modifiers.status, className) }, (widthChars && {
        ...
        React.createElement(InputGroup_1.InputGroup, null,
            ...
            React.createElement(TextInput_1.TextInput, Object.assign({ type: "number", value: value, name: inputName, "aria-label": inputAriaLabel }, (isDisabled && { isDisabled }), (onChange && { onChange: (value, event) => onChange(event) }), { onBlur: handleBlur }, (!onChange && { isReadOnly: true }), { onKeyDown: keyDownHandler, validated: validated }, inputProps)),
