...
const NumberInput = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: react_styles_1.css(number_input_1.default.numberInput, className) }, (widthChars && {
        ...
        React.createElement(InputGroup_1.InputGroup, null,
            ...
            React.createElement("input", Object.assign({ className: react_styles_1.css(number_input_1.default.formControl), type: "number", value: value, name: inputName, "aria-label": inputAriaLabel }, (isDisabled && { disabled: isDisabled }), (onChange && { onChange }), { onBlur: handleBlur }, (!onChange && { readOnly: true }), inputProps, { onKeyDown: keyDownHandler })),
