...
class MenuBase extends React.Component {
    ...
    componentDidMount() {
        ...
        helpers_2.setTabIndex(Array.from(ref.current.querySelector('ul').querySelectorAll('button, a')));
    }
    ...
    render() {
        ...
        return (React.createElement(MenuContext_1.MenuContext.Provider, { value: {
            ...
            isRootMenu && (React.createElement(helpers_2.KeyboardHandler, { containerRef: this.props.innerRef || this.menuRef || null, additionalKeyHandler: this.handleExtraKeys, createNavigableElements: this.createNavigableElements, isActiveElement: (element) => document.activeElement.parentElement === element ||
