...
const TextInputGroupMain = (_a) => {
    var { children, className, icon, onChange, 'aria-label': ariaLabel, value: inputValue } = _a, props = tslib_1.__rest(_a, ["children", "className", "icon", "onChange", 'aria-label', "value"]);
    return (React.createElement("div", Object.assign({ className: react_styles_1.css(text_input_group_1.default.textInputGroupMain, icon && text_input_group_1.default.modifiers.icon, className) }, props),
        ...
        React.createElement("span", { className: react_styles_1.css(text_input_group_1.default.textInputGroupText) },
            ...
            React.createElement("input", { type: "text", className: react_styles_1.css(text_input_group_1.default.textInputGroupTextInput), "aria-label": ariaLabel, onChange: onChange, value: inputValue }))));
};
exports.TextInputGroupMain = TextInputGroupMain;
exports.TextInputGroupMain.defaultProps = { 'aria-label': 'Type to filter' };
