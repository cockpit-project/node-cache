...
const TextInputGroup = (_a) => {
    ...
    return (React.createElement(exports.TextInputGroupContext.Provider, { value: { isDisabled } },
        React.createElement("div", Object.assign({ ref: textInputGroupRef, className: react_styles_1.css(text_input_group_1.default.textInputGroup, isDisabled && text_input_group_1.default.modifiers.disabled, isPlain && text_input_group_1.default.modifiers.plain, className) }, props), children)));
};
