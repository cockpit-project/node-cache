...
const TextInputGroup = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: react_styles_1.css(text_input_group_1.default.textInputGroup, className) }, props), children));
};
