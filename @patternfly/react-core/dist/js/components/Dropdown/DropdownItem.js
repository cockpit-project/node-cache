...
const DropdownItemBase = (_a) => {
    ...
    return (react_1.default.createElement(Menu_1.MenuItem, Object.assign({ className: (0, react_styles_1.css)(className), description: description, isDisabled: isDisabled, itemId: itemId, onClick: onClick, ref: innerRef }, ouiaProps, props), children));
};
