...
const DropdownGroup = ({ children = null, className = '', label = '' }) => (React.createElement(dropdownConstants_1.DropdownContext.Consumer, null, ({ sectionClass, sectionTitleClass, sectionComponent }) => {
