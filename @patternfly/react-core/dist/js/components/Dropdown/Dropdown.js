...
const DropdownBase = (_a) => {
    ...
    const menu = (react_1.default.createElement(Menu_1.Menu, Object.assign({ className: (0, react_styles_1.css)(className), ref: menuRef, onSelect: (event, itemId) => onSelect && onSelect(event, itemId, toggleRef), isPlain: isPlain, isScrollable: isScrollable }, props, ouiaProps),
        react_1.default.createElement(Menu_1.MenuContent, null, children)));
    return (react_1.default.createElement(Popper_1.Popper, Object.assign({ trigger: toggle(toggleRef), triggerRef: toggleRef, popper: menu, popperRef: menuRef, isVisible: isOpen, zIndex: zIndex }, popperProps)));
};
