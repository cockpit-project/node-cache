...
const DescriptionListGroup = ({ className, children }) => React.createElement("div", { className: react_styles_1.css(description_list_1.default.descriptionListGroup, className) }, children);
