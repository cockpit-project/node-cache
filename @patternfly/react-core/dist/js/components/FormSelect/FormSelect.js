...
class FormSelect extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("select", Object.assign({}, props, { className: (0, react_styles_1.css)(form_control_1.default.formControl, isIconSprite && form_control_1.default.modifiers.iconSprite, className, validated === constants_1.ValidatedOptions.success && form_control_1.default.modifiers.success, validated === constants_1.ValidatedOptions.warning && form_control_1.default.modifiers.warning, isSelectedPlaceholder && form_control_1.default.modifiers.placeholder), "aria-invalid": validated === constants_1.ValidatedOptions.error }, (0, helpers_1.getOUIAProps)(FormSelect.displayName, ouiaId !== undefined ? ouiaId : this.state.ouiaStateId, ouiaSafe), { onChange: this.handleChange, disabled: isDisabled, required: isRequired, value: value }), children));
    }
}
