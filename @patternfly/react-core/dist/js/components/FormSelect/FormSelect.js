...
class FormSelect extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("div", { className: (0, react_styles_1.css)(form_control_1.default.formControl, isDisabled && form_control_1.default.modifiers.disabled, isSelectedPlaceholder && form_control_1.default.modifiers.placeholder, hasStatusIcon && form_control_1.default.modifiers[validated], className) },
            ...
            React.createElement("div", { className: (0, react_styles_1.css)(form_control_1.default.formControlUtilities) },
                ...
                React.createElement(FormControlIcon_1.FormControlIcon, { customIcon: React.createElement(caret_down_icon_1.default, null) }))));
    }
}
