    ...
    constructor(props) {
        ...
        this.onToggle = (isOpen) => {
            ...
            this.setState(prevState => {
                ...
                const { delimiter, is24Hour, includeSeconds } = this.props;
                const time = (0, TimePickerUtils_1.parseTime)(prevState.timeState, timeRegex, delimiter, !is24Hour, includeSeconds);
                return {
    ...
    render() {
        ...
        return (React.createElement("div", { ref: this.baseComponentRef, className: (0, react_styles_1.css)(date_picker_1.default.datePicker, className) },
            React.createElement("div", Object.assign({ className: (0, react_styles_1.css)(date_picker_1.default.datePickerInput), style: style }, props),
                ...
                isInvalid && (React.createElement("div", { className: (0, react_styles_1.css)(date_picker_1.default.datePickerHelperText, date_picker_1.default.modifiers.error) }, !isValidFormat ? invalidFormatErrorMessage : invalidMinMaxErrorMessage)))));
    }
}
