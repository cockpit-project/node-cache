...
class TextAreaBase extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("div", { className: (0, react_styles_1.css)(form_control_1.default.formControl, readOnlyVariant && form_control_1.default.modifiers.readonly, readOnlyVariant === 'plain' && form_control_1.default.modifiers.plain, resizeOrientation && form_control_1.default.modifiers[orientation], isDisabled && form_control_1.default.modifiers.disabled, hasStatusIcon && form_control_1.default.modifiers[validated], className) },
            ...
            hasStatusIcon && (React.createElement("div", { className: (0, react_styles_1.css)(form_control_1.default.formControlUtilities) },
