...
exports.KeyboardHandler = exports.handleArrows = void 0;
 ...
 */
exports.handleArrows = (event, navigableElements, isActiveElement = element => document.activeElement.contains(element), getFocusableElement = element => element, validSiblingTags = ['A', 'BUTTON'], noVerticalArrowHandling = false, noHorizontalArrowHandling = false, updateTabIndex = true) => {
...
class KeyboardHandler extends React.Component {
    constructor() {
        ...
        this.keyHandler = (event) => {
            ...
            exports.handleArrows(event, navigableElements, isActiveElement, getFocusableElement, validSiblingTags, noVerticalArrowHandling, noHorizontalArrowHandling, updateTabIndex);
        };
