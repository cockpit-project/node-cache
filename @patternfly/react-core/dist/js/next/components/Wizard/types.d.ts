...
export declare type CustomWizardNavFunction = (isExpanded: boolean, steps: WizardControlStep[], currentStep: WizardControlStep, goToStepByIndex: (index: number) => void) => React.ReactElement<WizardNavProps>;
/** Callback for the Wizard's 'navItem' property. Returns element which replaces the WizardStep's default navigation item. */
export declare type CustomWizardNavItemFunction = (step: WizardControlStep, currentStep: WizardControlStep, steps: WizardControlStep[], goToStepByIndex: (index: number) => void) => React.ReactElement<WizardNavItemProps>;
/** Callback for the Wizard's 'footer' property. Returns element which replaces the Wizard's default footer. */
export declare type CustomWizardFooterFunction = (currentStep: WizardControlStep, onNext: () => void, onBack: () => void, onClose: () => void) => React.ReactElement<WizardFooterProps>;
