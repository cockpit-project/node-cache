...
const WizardFooter = (_a) => {
    var { currentStep } = _a, internalProps = tslib_1.__rest(_a, ["currentStep"]);
    const currentStepFooter = !types_1.isCustomWizardFooter(currentStep.footer) && currentStep.footer;
    return react_1.default.createElement(InternalWizardFooter, Object.assign({}, internalProps, currentStepFooter));
};
