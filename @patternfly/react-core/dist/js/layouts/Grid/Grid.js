...
exports.Grid = (_a) => {
    var { children = null, className = '', hasGutter, span = null, order, style } = _a, props = tslib_1.__rest(_a, ["children", "className", "hasGutter", "span", "order", "style"]);
    ...
    return (React.createElement("div", Object.assign({ className: react_styles_1.css(...classes, hasGutter && grid_1.default.modifiers.gutter, className), style: style || order ? Object.assign(Object.assign({}, style), util_1.setBreakpointCssVars(order, gridToken.l_grid_item_Order.name)) : undefined }, props), children));
};
