...
const gridToken = tslib_1.__importStar(require("@patternfly/react-tokens/dist/esm/l_grid_item_Order"));
...
const GridItem = (_a) => {
    ...
    return (React.createElement(Component, Object.assign({ className: (0, react_styles_1.css)(...classes, className), style: style || order ? Object.assign(Object.assign({}, style), (0, util_1.setBreakpointCssVars)(order, gridToken.l_grid_item_Order.name)) : undefined }, props), children));
};
