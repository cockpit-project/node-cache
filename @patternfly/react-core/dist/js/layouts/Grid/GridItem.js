...
exports.GridItem = (_a) => {
    var { children = null, className = '', span = null, rowSpan = null, offset = null, order, style } = _a, props = tslib_1.__rest(_a, ["children", "className", "span", "rowSpan", "offset", "order", "style"]);
    const classes = [
    ...
    return (React.createElement("div", Object.assign({ className: react_styles_1.css(...classes, className), style: style || order ? Object.assign(Object.assign({}, style), util_1.setBreakpointCssVars(order, gridToken.l_grid_item_Order.name)) : undefined }, props), children));
};
