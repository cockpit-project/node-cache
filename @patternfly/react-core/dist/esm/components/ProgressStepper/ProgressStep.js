...
const ProgressStepBase = (_a) => {
    var { children, className, variant, isCurrent, description, icon, titleId, popover, innerRef, 'aria-label': ariaLabel } = _a, props = __rest(_a, ["children", "className", "variant", "isCurrent", "description", "icon", "titleId", "popover", "innerRef", 'aria-label']);
