...
export class FormSelect extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("div", { className: css(styles.formControl, isDisabled && styles.modifiers.disabled, isSelectedPlaceholder && styles.modifiers.placeholder, hasStatusIcon && styles.modifiers[validated], className) },
            ...
            React.createElement("div", { className: css(styles.formControlUtilities) },
                hasStatusIcon && React.createElement(FormControlIcon, { status: validated }),
                React.createElement(FormControlIcon, { customIcon: React.createElement(CaretDownIcon, null) }))));
    }
}
