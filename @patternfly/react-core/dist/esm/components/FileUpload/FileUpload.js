...
export const FileUpload = (_a) => {
    ...
    return (React.createElement(Dropzone, Object.assign({ multiple: false }, dropzoneProps, { onDropAccepted: onDropAccepted, onDropRejected: onDropRejected, noClick: true }), ({ getRootProps, getInputProps, isDragActive, open }) => {
