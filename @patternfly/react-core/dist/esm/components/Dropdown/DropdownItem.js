...
const DropdownItemBase = (_a) => {
    ...
    return (React.createElement(MenuItem, Object.assign({ ref: innerRef, className: css(className), description: description, isDisabled: isDisabled, itemId: itemId, onClick: onClick }, ouiaProps, props), children));
};
