...
const DropdownBase = (_a) => {
    ...
    const menu = (React.createElement(Menu, Object.assign({ className: css(className), ref: menuRef, onSelect: (event, itemId) => onSelect && onSelect(event, itemId, toggleRef), isPlain: isPlain, isScrollable: isScrollable }, props, ouiaProps),
        React.createElement(MenuContent, null, children)));
    return (React.createElement(Popper, Object.assign({ trigger: toggle(toggleRef), triggerRef: toggleRef, popper: menu, popperRef: menuRef, isVisible: isOpen, zIndex: zIndex }, popperProps)));
};
