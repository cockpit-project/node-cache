...
export const DataListCheck = (_a) => {
    ...
    const check = (React.createElement("div", { className: css(styles.dataListCheck) },
        React.createElement("input", Object.assign({}, props, { type: "checkbox", onChange: event => onChange(event.currentTarget.checked, event), "aria-invalid": !isValid, disabled: isDisabled }, (checked !== null && { defaultChecked: checked }), (isChecked !== null && { checked: isChecked })))));
