...
export class TextAreaBase extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("div", { className: css(styles.formControl, readOnlyVariant && styles.modifiers.readonly, readOnlyVariant === 'plain' && styles.modifiers.plain, resizeOrientation && styles.modifiers[orientation], isDisabled && styles.modifiers.disabled, hasStatusIcon && styles.modifiers[validated], className) },
            ...
            hasStatusIcon && (React.createElement("div", { className: css(styles.formControlUtilities) },
