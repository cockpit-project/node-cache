...
export class PaginationOptionsMenu extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(DropdownContext.Provider, { value: {
            ...
            React.createElement(DropdownWithContext, { direction: dropDirection, isOpen: isOpen, toggle: React.createElement(OptionsToggle, { optionsToggle: optionsToggle, itemsPerPageTitle: itemsPerPageTitle, showToggle: perPageOptions && perPageOptions.length > 0, onToggle: this.onToggle, isOpen: isOpen, widgetId: widgetId, firstIndex: firstIndex, lastIndex: lastIndex, itemCount: itemCount, itemsTitle: itemsTitle, ofWord: ofWord, toggleTemplate: toggleTemplate
                        ? toggleTemplate
                        : ({ firstIndex, lastIndex, itemCount, ofWord, itemsTitle }) => (React.createElement(React.Fragment, null,
                            ...
                            " ",
                            itemsTitle)), parentRef: this.parentRef.current, isDisabled: isDisabled }), dropdownItems: this.renderItems(), isPlain: true })));
    }
}
