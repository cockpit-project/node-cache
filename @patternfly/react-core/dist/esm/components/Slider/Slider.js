    ...
    const displayInput = () => {
        ...
        if (inputLabel) {
            return (React.createElement(InputGroup, null,
                ...
                React.createElement(InputGroupItem, { isBox: true },
                    React.createElement(InputGroupText, Object.assign({}, (isDisabled && { className: css(styles.modifiers.disabled) })), inputLabel))));
        }
        else {
            return textInput;
        }
