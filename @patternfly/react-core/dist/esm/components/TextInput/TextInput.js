...
export class TextInputBase extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("div", { className: css(styles.formControl, readOnlyVariant && styles.modifiers.readonly, readOnlyVariant === 'plain' && styles.modifiers.plain, isDisabled && styles.modifiers.disabled, isExpanded && styles.modifiers.expanded, customIcon && styles.modifiers.icon, hasStatusIcon && styles.modifiers[validated], className) },
            ...
            (customIcon || hasStatusIcon) && (React.createElement("div", { className: css(styles.formControlUtilities) },
