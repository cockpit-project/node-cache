...
export const MenuContent = React.forwardRef((props, ref) => {
    ...
    return (React.createElement(MenuContext.Consumer, null, ({ menuId, onGetMenuHeight, isScrollable }) => (React.createElement("div", Object.assign({}, rest, { className: css(styles.menuContent, props.className), ref: el => refCallback(el, menuId, onGetMenuHeight), style: {
