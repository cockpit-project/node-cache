...
export class MenuToggleBase extends React.Component {
    ...
    render() {
        ...
        if (isTypeahead) {
            return React.createElement("div", Object.assign({ ref: innerRef, className: css(commonStyles) }, componentProps));
        }
        if (splitButtonOptions) {
            return (React.createElement("div", { className: css(commonStyles, styles.modifiers.splitButton, (splitButtonOptions === null || splitButtonOptions === void 0 ? void 0 : splitButtonOptions.variant) === 'action' && styles.modifiers.action) }, splitButtonOptions === null || splitButtonOptions === void 0 ? void 0 :
                splitButtonOptions.items,
                React.createElement("button", Object.assign({ className: css(styles.menuToggleButton), type: "button", "aria-expanded": isExpanded, "aria-label": ariaLabel, disabled: isDisabled }, otherProps), toggleControls)));
        }
