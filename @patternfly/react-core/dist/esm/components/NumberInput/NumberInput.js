...
export const NumberInput = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: css(styles.numberInput, className) }, (widthChars && {
        ...
        React.createElement(InputGroup, null,
            ...
            React.createElement("input", Object.assign({ className: css(styles.formControl), type: "number", value: value, name: inputName, "aria-label": inputAriaLabel }, (isDisabled && { disabled: isDisabled }), (onChange && { onChange }), { onBlur: handleBlur }, (!onChange && { readOnly: true }), inputProps, { onKeyDown: keyDownHandler })),
