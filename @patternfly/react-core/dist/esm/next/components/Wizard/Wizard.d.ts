...
export declare const Wizard: {
    ({ startIndex, children, footer, height, width, className, header, nav, unmountInactiveSteps, onNavByIndex, onNext, onBack, onSave, onClose, ...wrapperProps }: WizardProps): JSX.Element;
    displayName: string;
};
