...
export declare const Wizard: {
    ({ children, footer, height, width, className, header, nav, startIndex, isStepVisitRequired, hasUnmountedSteps, onNavByIndex, onNext, onBack, onSave, onClose, ...wrapperProps }: WizardProps): JSX.Element;
    displayName: string;
};
