...
export const WizardToggle = ({ steps, activeStep, footer, nav, isNavExpanded, toggleNavExpanded, unmountInactiveSteps = true, 'aria-label': ariaLabel = 'Wizard toggle' }) => {
...
export const WizardToggleInternal = ({ nav, unmountInactiveSteps }) => {
    ...
    const wizardNav = React.useMemo(() => {
        ...
        return (React.createElement(WizardNav, Object.assign({}, navProps), steps.map((step, index) => {
            var _a;
            ...
            if (isWizardParentStep(step)) {
                ...
                return (stepNavItem || (React.createElement(WizardNavItem, { key: step.id, id: step.id, content: step.name, isExpandable: nav === null || nav === void 0 ? void 0 : nav.isExpandable, isCurrent: hasActiveChild, isDisabled: !hasEnabledChildren, step: firstSubStepIndex, onNavItemClick: goToStepByIndex },
                    React.createElement(WizardNav, Object.assign({}, navProps, { returnList: true }), subNavItems))));
            }
    ...
    return (React.createElement(WizardToggle, { nav: wizardNav, footer: footer, steps: steps, activeStep: activeStep, isNavExpanded: isNavExpanded, toggleNavExpanded: () => setIsNavExpanded(prevIsExpanded => !prevIsExpanded), unmountInactiveSteps: unmountInactiveSteps }));
};
