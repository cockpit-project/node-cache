...
const VncActions = ({ textSendShortcut = 'Send Key', textCtrlAltDel = 'Ctrl+Alt+Del', textDisconnect = 'Disconnect', onCtrlAltDel = undefined, onDisconnect, additionalButtons = [] }) => {
    ...
    const toolbar = (react_1.default.createElement("div", { className: react_styles_1.css(VncConsole_1.default.consoleActionsVnc) },
        additionalButtons,
        react_1.default.createElement(react_core_1.Dropdown, { id: "pf-c-console__send-shortcut", onSelect: () => setIsOpen(false), toggle: react_1.default.createElement(react_core_1.DropdownToggle, { id: "pf-c-console__actions-vnc-toggle-id", onToggle: () => setIsOpen(!isOpen) }, textSendShortcut), isOpen: isOpen, dropdownItems: [
                react_1.default.createElement(react_core_1.DropdownItem, { onClick: onCtrlAltDel, key: "ctrl-alt-delete" }, textCtrlAltDel)
            ] }),
