...
const ConnectWithRemoteViewer = ({ onGenerate = consoleDescriptorGenerator_1.generateDescriptorFile, onDownload = consoleDescriptorGenerator_1.downloadFile, spice = null, vnc = null, rdp = null, textConnectWithRemoteViewer = 'Launch Remote Viewer', textConnectWithRDP = 'Launch Remote Desktop', textMoreInfo = 'Remote Viewer Details', textMoreInfoContent = '', textMoreRDPInfo = 'Remote Desktop Details', textMoreRDPInfoContent = '' }) => {
    ...
    return (react_1.default.createElement("div", { className: "pf-c-console__remote-viewer" },
        react_1.default.createElement("div", { className: "pf-c-console__remote-viewer-launch" },
            react_1.default.createElement(react_core_1.Button, { className: "pf-c-console__remote-viewer-launch-vv", onClick: onClickVV, isDisabled: !_console }, textConnectWithRemoteViewer),
            !!rdp && (react_1.default.createElement(react_core_1.Button, { onClick: onClickRDP, className: "pf-c-console__remote-viewer-launch-rdp" }, textConnectWithRDP))),
        !!_console && (react_1.default.createElement(react_core_1.ExpandableSection, { toggleText: textMoreInfo, isExpanded: isExpandedDefault, onToggle: isExpanded => setIsExpandedDefault(isExpanded) },
        ...
        !!rdp && (react_1.default.createElement(react_core_1.ExpandableSection, { toggleText: textMoreRDPInfo, isExpanded: isExpandedRDP, onToggle: isExpanded => setIsExpandedRDP(isExpanded) },
