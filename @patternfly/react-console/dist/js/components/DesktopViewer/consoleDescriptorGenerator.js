...
exports.generateDescriptorFile = exports.downloadFile = void 0;
const file_saver_1 = require("file-saver");
const constants_1 = require("../common/constants");
const { VNC_CONSOLE_TYPE, SPICE_CONSOLE_TYPE, RDP_CONSOLE_TYPE, DEFAULT_VV_MIMETYPE, DEFAULT_RDP_MIMETYPE, DEFAULT_RDP_PORT } = constants_1.constants;
/**
 ...
 */
function generateVVFile(_console, type) {
    const TYPES = {
        [VNC_CONSOLE_TYPE]: 'vnc',
        [SPICE_CONSOLE_TYPE]: 'spice'
    };
    const content = '[virt-viewer]\n' +
 ...
 * @param {string} _console Object describing the console file content
 */
function generateRDPFile(_console) {
 ...
 * @param {string} type VNC_CONSOLE_TYPE | SPICE_CONSOLE_TYPE
 */
function generateDescriptorFile(_console, type) {
...
//# sourceMappingURL=consoleDescriptorGenerator.js.map