...
export const ConnectWithRemoteViewer = ({ onGenerate = generateDescriptorFile, onDownload = downloadFile, spice = null, vnc = null, rdp = null, textConnectWithRemoteViewer = 'Launch Remote Viewer', textConnectWithRDP = 'Launch Remote Desktop', textMoreInfo = 'Remote Viewer Details', textMoreInfoContent = '', textMoreRDPInfo = 'Remote Desktop Details', textMoreRDPInfoContent = '' }) => {
    ...
    return (React.createElement("div", { className: "pf-c-console__remote-viewer" },
        React.createElement("div", { className: "pf-c-console__remote-viewer-launch" },
            React.createElement(Button, { className: "pf-c-console__remote-viewer-launch-vv", onClick: onClickVV, isDisabled: !_console }, textConnectWithRemoteViewer),
            !!rdp && (React.createElement(Button, { onClick: onClickRDP, className: "pf-c-console__remote-viewer-launch-rdp" }, textConnectWithRDP))),
        !!_console && (React.createElement(ExpandableSection, { toggleText: textMoreInfo, isExpanded: isExpandedDefault, onToggle: isExpanded => setIsExpandedDefault(isExpanded) },
            React.createElement(MoreInformationDefaultContent, { textMoreInfoContent: textMoreInfoContent }))),
        !!rdp && (React.createElement(ExpandableSection, { toggleText: textMoreRDPInfo, isExpanded: isExpandedRDP, onToggle: isExpanded => setIsExpandedRDP(isExpanded) },
