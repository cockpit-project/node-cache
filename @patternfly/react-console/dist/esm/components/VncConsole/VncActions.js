...
export const VncActions = ({ textSendShortcut = 'Send Key', textCtrlAltDel = 'Ctrl+Alt+Del', textDisconnect = 'Disconnect', onCtrlAltDel = undefined, onDisconnect, additionalButtons = [] }) => {
    ...
    const toolbar = (React.createElement("div", { className: css(styles.consoleActionsVnc) },
        additionalButtons,
        React.createElement(DropdownDeprecated, { id: "pf-c-console__send-shortcut", onSelect: () => setIsOpen(false), toggle: React.createElement(DropdownToggleDeprecated, { id: "pf-c-console__actions-vnc-toggle-id", onToggle: () => setIsOpen(!isOpen) }, textSendShortcut), isOpen: isOpen, dropdownItems: [
