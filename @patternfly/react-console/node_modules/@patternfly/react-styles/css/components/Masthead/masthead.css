...
.pf-v5-c-masthead {
  ...
  align-items: center;
  min-width: 0;
  padding-right: var(--pf-v5-c-masthead--PaddingRight);
  padding-left: var(--pf-v5-c-masthead--PaddingLeft);
...
.pf-v5-c-masthead__main {
  ...
  padding-top: var(--pf-v5-c-masthead__main--PaddingTop);
  padding-bottom: var(--pf-v5-c-masthead__main--PaddingBottom);
  margin-right: var(--pf-v5-c-masthead__main--MarginRight);
}
.pf-v5-c-masthead__main::before {
  position: absolute;
  right: var(--pf-v5-c-masthead__main--before--Right);
  bottom: 0;
  left: var(--pf-v5-c-masthead__main--before--Left);
  content: "";
  border-bottom: var(--pf-v5-c-masthead__main--before--BorderBottom);
}
...
.pf-v5-c-masthead__content {
  ...
  padding-top: var(--pf-v5-c-masthead__content--PaddingTop);
  padding-bottom: var(--pf-v5-c-masthead__content--PaddingBottom);
  margin-left: var(--pf-v5-c-masthead__content--MarginLeft);
}
...
.pf-v5-c-masthead__content .pf-v5-c-nav.pf-m-horizontal {
  margin-right: var(--pf-v5-c-masthead__content--c-nav--m-horizontal--MarginRight);
  margin-left: var(--pf-v5-c-masthead__content--c-nav--m-horizontal--MarginLeft);
}
...
.pf-v5-c-masthead__toggle {
  ...
  align-self: center;
  margin-right: var(--pf-v5-c-masthead__toggle--MarginRight);
  margin-left: var(--pf-v5-c-masthead__toggle--MarginLeft);
}
