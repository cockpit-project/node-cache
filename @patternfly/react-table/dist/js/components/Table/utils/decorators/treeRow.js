    ...
    return {
        ...
        children: level !== undefined ? (React.createElement("div", { className: (0, react_styles_1.css)(table_tree_view_1.default.tableTreeViewMain) },
            setsize > 0 && (React.createElement("span", { className: (0, react_styles_1.css)(table_tree_view_1.default.tableToggle), key: "table-toggle" },
                React.createElement(react_core_1.Button, { variant: "plain", onClick: event => onCollapse && onCollapse(event, rowIndex, content, rowData), className: (0, react_styles_1.css)(isExpanded && table_1.default.modifiers.expanded), "aria-expanded": isExpanded, "aria-label": toggleAriaLabel || `${isExpanded ? 'Collapse' : 'Expand'} row ${rowIndex}` },
            ...
            !!onCheckChange && (React.createElement("span", { className: (0, react_styles_1.css)(table_tree_view_1.default.tableCheck), key: "table-check" },
                React.createElement("label", { htmlFor: checkboxId || `checkbox_${rowIndex}` },
                    React.createElement(react_core_1.Checkbox, { id: checkboxId || `checkbox_${rowIndex}`, "aria-label": checkAriaLabel || `Row ${rowIndex} checkbox`, isChecked: isChecked, onChange: (event, checked) => onChange(checked, event) })))),
            text,
