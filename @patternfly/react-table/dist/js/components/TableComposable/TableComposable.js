...
const TableComposableBase = (_a) => {
    ...
    return (React.createElement("table", Object.assign({ "aria-label": ariaLabel, role: role, className: react_styles_1.css(className, table_1.default.table, !isTreeTable && grid, table_1.default.modifiers[variant], !borders && table_1.default.modifiers.noBorderRows, isStickyHeader && table_1.default.modifiers.stickyHeader, isTreeTable && table_tree_view_1.default.modifiers.treeView), ref: innerRef }, (isTreeTable && { role: 'treegrid' }), ouiaProps, props), children));
};
