    ...
    */
    ...
    class SelectMenuWithRef extends React.Component {
        ...
        renderSelectMenu({ variant, inputIdPrefix }) {
            ...
            /* eslint-enable @typescript-eslint/no-unused-vars */
            let Component = 'div';
            const variantProps = Object.assign({ ref: innerRef, className: css(!footer ? styles$5.selectMenu : 'pf-c-select__menu-list', className) }, (maxHeight && { style: { maxHeight, overflow: 'auto' } }));
            ...
            if (isCustomContent) {
                ...
                if (React.Children.count(children) === 0) {
                    variantProps.children = React.createElement("fieldset", { className: css(styles$5.selectMenuFieldset) });
                }
                else {
            ...
            return (React.createElement(React.Fragment, null,
                ...
                footer && (React.createElement("div", { className: css(styles$5.selectMenuFooter), ref: footerRef }, footer))));
        }
        render() {
    ...
    const BodyCell = (_a) => {
        ...
        const cell = (React.createElement(Td, Object.assign({ className: className, component: component, dataLabel: dataLabel && parentId == null ? dataLabel : null, onMouseEnter: onMouseEnter, textCenter: textCenter, colSpan: colSpan }, props), children));
