(function (global, factory) {
    ...
    ***************************************************************************** */
     ...
     */
    const getResizeObserver = (containerRef, handleResize) => {
        let unobserve;
        if (canUseDOM) {
    ...
    class SelectToggle extends React__namespace.Component {
        ...
        render() {
            ...
            return (React__namespace.createElement(React__namespace.Fragment, null,
                !isTypeahead && (React__namespace.createElement("button", Object.assign({}, props, toggleProps, { ref: this.toggle, type: type, className: css(_default$a.selectToggle, hasPlaceholderStyle && _default$a.modifiers.placeholder, isDisabled && _default$a.modifiers.disabled, isPlain && _default$a.modifiers.plain, isActive && _default$a.modifiers.active, className), "aria-label": ariaLabel, 
                    // eslint-disable-next-line @typescript-eslint/no-unused-vars
                    onClick: _event => {
                        onToggle(!isOpen);
                        if (isOpen) {
                ...
                isTypeahead && (React__namespace.createElement("div", Object.assign({}, props, { ref: this.toggle, className: css(_default$a.selectToggle, hasPlaceholderStyle && _default$a.modifiers.placeholder, isDisabled && _default$a.modifiers.disabled, isPlain && _default$a.modifiers.plain, isTypeahead && _default$a.modifiers.typeahead, className), 
                    // eslint-disable-next-line @typescript-eslint/no-unused-vars
                    onClick: _event => {
                        if (!isDisabled) {
                            onToggle(!isOpen);
