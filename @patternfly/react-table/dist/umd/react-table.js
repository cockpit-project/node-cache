(function (global, factory) {
    ...
    */
    ...
    const ButtonBase = (_a) => {
        ...
        return (React__namespace.createElement(Component, Object.assign({}, props, (isAriaDisabled ? preventedEvents : null), { "aria-disabled": isDisabled || isAriaDisabled, "aria-label": ariaLabel, className: css(_default$i.button, _default$i.modifiers[variant], isBlock && _default$i.modifiers.block, isDisabled && _default$i.modifiers.disabled, isAriaDisabled && _default$i.modifiers.ariaDisabled, isActive && _default$i.modifiers.active, isInline && variant === ButtonVariant.link && _default$i.modifiers.inline, isDanger && (variant === ButtonVariant.secondary || variant === ButtonVariant.link) && _default$i.modifiers.danger, isLoading !== null && children !== null && _default$i.modifiers.progress, isLoading && _default$i.modifiers.inProgress, isSmall && _default$i.modifiers.small, isLarge && _default$i.modifiers.displayLg, className), disabled: isButtonElement ? isDisabled : null, tabIndex: tabIndex !== null ? tabIndex : getDefaultTabIdx(), type: isButtonElement || isInlineSpan ? type : null, role: isInlineSpan ? 'button' : null, ref: innerRef }, ouiaProps),
    ...
    ***************************************************************************** */
    ...
    const Tooltip = (_a) => {
        ...
        const positionModifiers = {
            ...
            'top-start': _default$g.modifiers.topLeft,
            'top-end': _default$g.modifiers.topRight,
            'bottom-start': _default$g.modifiers.bottomLeft,
            'bottom-end': _default$g.modifiers.bottomRight,
            'left-start': _default$g.modifiers.leftTop,
            'left-end': _default$g.modifiers.leftBottom,
            'right-start': _default$g.modifiers.rightTop,
            'right-end': _default$g.modifiers.rightBottom
        };
    ...
    class TextInputBase extends React__namespace.Component {
        ...
        render() {
            ...
            return (React__namespace.createElement("input", Object.assign({}, props, { onFocus: this.onFocus, onBlur: this.onBlur, className: css(_default$f.formControl, isIconSprite && _default$f.modifiers.iconSprite, validated === ValidatedOptions.success && _default$f.modifiers.success, validated === ValidatedOptions.warning && _default$f.modifiers.warning, ((iconVariant && iconVariant !== 'search') || customIconUrl) && _default$f.modifiers.icon, iconVariant && _default$f.modifiers[iconVariant], className), onChange: this.handleChange, type: type, value: this.sanitizeInputValue(value), "aria-invalid": props['aria-invalid'] ? props['aria-invalid'] : validated === ValidatedOptions.error, required: isRequired, disabled: isDisabled, readOnly: isReadOnly, ref: innerRef || this.inputRef }, ((customIconUrl || customIconDimensions) && { style: customIconStyle }), getOUIAProps(TextInput.displayName, ouiaId !== undefined ? ouiaId : this.state.ouiaStateId, ouiaSafe))));
        }
    }
        ...
        render() {
            ...
            const renderOption = (onSelect, onClose, variant, inputIdPrefix, onFavorite, shouldResetOnSelect) => {
                if (variant !== SelectVariant.checkbox && isLoading && isGrouped) {
                    ...
                    return (React__namespace.createElement("li", { id: generatedId, role: "presentation", className: css(isLoading && _default$b.selectListItem, !isLoading && _default$b.selectMenuWrapper, isFavorite && _default$b.modifiers.favorite, isFocused && _default$b.modifiers.focus, isLoading && _default$b.modifiers.loading), ref: this.liRef },
                        isLoading && children,
        ...
        render() {
            ...
            return (React__namespace.createElement(React__namespace.Fragment, null,
                ...
                isTypeahead && (React__namespace.createElement("div", Object.assign({}, props, { ref: this.toggle, className: css(_default$b.selectToggle, hasPlaceholderStyle && _default$b.modifiers.placeholder, isDisabled && _default$b.modifiers.disabled, isPlain && _default$b.modifiers.plain, isTypeahead && _default$b.modifiers.typeahead, className), 
                    ...
                    children,
                    React__namespace.createElement("button", Object.assign({}, toggleProps, { type: type, className: css(_default$i.button, _default$b.selectToggleButton, _default$b.modifiers.plain), "aria-label": ariaLabel, onClick: event => {
                            onToggle(!isOpen, event);
                            if (isOpen) {
                                onClose();
                            }
    ...
    class ChipGroup extends React__namespace.Component {
        ...
        renderLabel(id) {
            ...
            return isTooltipVisible ? (React__namespace.createElement(Tooltip, { position: tooltipPosition, content: categoryName },
                React__namespace.createElement("span", { tabIndex: 0, ref: this.headingRef, className: css(_default$8.chipGroupLabel) },
                    React__namespace.createElement("span", { id: id }, categoryName)))) : (React__namespace.createElement("span", { ref: this.headingRef, className: css(_default$8.chipGroupLabel), id: id }, categoryName));
        }
        render() {
            ...
            const renderChipGroup = (id) => {
                ...
                return (React__namespace.createElement("div", Object.assign({ className: css(_default$8.chipGroup, className, categoryName && _default$8.modifiers.category), role: "group" }, (categoryName && { 'aria-labelledby': id }), (!categoryName && { 'aria-label': ariaLabel }), getOUIAProps(ChipGroup.displayName, ouiaId)),
    ...
    const TbodyBase = (_a) => {
        ...
        return (React__namespace.createElement("tbody", Object.assign({ role: "rowgroup", className: css(className, isExpanded && _default$3.modifiers.expanded, isOddStriped && _default$3.modifiers.striped, isEvenStriped && _default$3.modifiers.stripedEven), ref: innerRef }, props), children));
    };
    ...
    const CollapseColumn = (_a) => {
        ...
        return (React__namespace.createElement(React__namespace.Fragment, null,
            isOpen !== undefined && (React__namespace.createElement(Button, Object.assign({ className: css(className, isOpen && _default$3.modifiers.expanded) }, props, { variant: "plain", "aria-label": props['aria-label'] || 'Details', onClick: onToggle, "aria-expanded": isOpen }),
    ...
    const collapsible = (value, { rowIndex, columnIndex, rowData, column, property }) => {
        ...
        return {
            className: ((rowData === null || rowData === void 0 ? void 0 : rowData.isOpen) !== undefined || rowId === -1) && css(_default$3.tableToggle),
