    ...
    */
    ...
    class DropdownWithContext extends React.Component {
        ...
        render() {
            ...
            return (React.createElement(DropdownContext.Consumer, null, ({ baseClass, baseComponent, id: contextId, ouiaId, ouiaComponentType, ouiaSafe, alignments }) => {
                ...
                const mainContainer = (React.createElement(BaseComponent, Object.assign({}, props, { className: css(baseClass, direction === DropdownDirection.up && styles$4.modifiers.top, position === DropdownPosition.right && styles$4.modifiers.alignRight, isOpen && styles$4.modifiers.expanded, className), ref: this.baseComponentRef }, getOUIAProps(ouiaComponentType, ouiaId, ouiaSafe)),
    ...
    const Dropdown = (_a) => {
        ...
        return (React.createElement(DropdownContext.Provider, { value: {
                ...
                toggleTextClass: styles$4.dropdownToggleText,
                toggleIconClass: styles$4.dropdownToggleImage,
                toggleIndicatorClass: styles$4.dropdownToggleIcon,
                menuClass: styles$4.dropdownMenu,
                itemClass: styles$4.dropdownMenuItem,
                toggleClass: styles$4.dropdownToggle,
                baseClass: styles$4.dropdown,
                baseComponent: 'div',
                sectionClass: styles$4.dropdownGroup,
                sectionTitleClass: styles$4.dropdownGroupTitle,
                sectionComponent: 'section',
                disabledClass: styles$4.modifiers.disabled,
                plainTextClass: styles$4.modifiers.text,
    ...
    class InternalDropdownItem extends React.Component {
        ...
        render() {
            ...
            let classes = css(icon && styles$4.modifiers.icon, className);
            if (component === 'a') {
    ...
    const TableComposableBase = (_a) => {
        ...
        return (React.createElement("table", Object.assign({ "aria-label": ariaLabel, role: role, className: css(className, styles$b.table, isTreeTable ? treeGrid : grid, styles$b.modifiers[variant], !borders && styles$b.modifiers.noBorderRows, isStickyHeader && styles$b.modifiers.stickyHeader, isTreeTable && stylesTreeView.modifiers.treeView), ref: innerRef }, (isTreeTable && { role: 'treegrid' }), ouiaProps, props), children));
    };
