(function (global, factory) {
    ...
    */
    ...
    const TableComposableBase = (_a) => {
        ...
        return (React.createElement("table", Object.assign({ "aria-label": ariaLabel, role: role, className: css(className, styles$9.table, !isTreeTable && grid, styles$9.modifiers[variant], !borders && styles$9.modifiers.noBorderRows, isStickyHeader && styles$9.modifiers.stickyHeader, isTreeTable && stylesTreeView.modifiers.treeView), ref: innerRef }, (isTreeTable && { role: 'treegrid' }), ouiaProps, props), children));
    };
    ...
    const treeRow = (onCollapse, onCheckChange) => (value, { rowIndex, rowData }) => {
    ...
    const TreeRowWrapper = (_a) => {
        ...
        return (React.createElement(Tr, Object.assign({ "aria-level": level, "aria-posinset": posinset, "aria-setsize": setsize, "aria-expanded": !!isExpanded, isHidden: isHidden, className: css(className, isExpanded && 'pf-m-expandable', isExpanded && styles$9.modifiers.expanded) }, props)));
    };
