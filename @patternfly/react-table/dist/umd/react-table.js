(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    const Tooltip = (_a) => {
        ...
        const content = (React__namespace.createElement("div", Object.assign({ className: css(styles$9.tooltip, className), role: "tooltip", id: id, style: {
    ...
    const Divider = (_a) => {
        ...
        const Component = component;
        return (React__namespace.createElement(Component, Object.assign({ className: css(styles$7.divider, isVertical && styles$7.modifiers.vertical, formatBreakpointMods(inset, styles$7), className) }, (component !== 'hr' && { role: 'separator' }), props)));
    };
    ...
    class SelectToggle extends React__namespace.Component {
        ...
        render() {
            ...
            return (React__namespace.createElement(React__namespace.Fragment, null,
                ...
                isTypeahead && (React__namespace.createElement("div", Object.assign({}, props, { ref: this.toggle, className: css(styles$6.selectToggle, hasPlaceholderStyle && styles$6.modifiers.placeholder, isDisabled && styles$6.modifiers.disabled, isPlain && styles$6.modifiers.plain, isTypeahead && styles$6.modifiers.typeahead, className), 
                    // eslint-disable-next-line @typescript-eslint/no-unused-vars
                    onClick: event => {
                        if (!isDisabled) {
                            onToggle(!isOpen, event);
